...
public class JoinChallengeResponse {
    ...
    @Builder
    public JoinChallengeResponse(ChallengeHistoryInfo challengeHistory, List<MissionHistoryInfo> missionHistories) {
    ...
    public static JoinChallengeResponse of(ChallengeHistory challengeHistory, List<MissionHistory> missionHistories) {
