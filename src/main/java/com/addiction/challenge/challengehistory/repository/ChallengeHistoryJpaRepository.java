...
public interface ChallengeHistoryJpaRepository extends JpaRepository<ChallengeHistory, Long> {
     ...
     * 사용자의 특정 챌린지 히스토리 조회
     */
    Optional<ChallengeHistory> findFirstByUserIdAndChallengeIdOrderByCreatedDateDescIdDesc(Long userId,
                                                                                            Long challengeId);

    /**
     * 사용자의 진행중인 챌린지 조회 (최신순 1개)
     */
    Optional<ChallengeHistory> findFirstByUserIdAndStatusOrderByCreatedDateDescIdDesc(Long userId,
